...
import { normalizeSlideContentWithCharts, normalizeDeckSpecWithCharts, validateDeckSpecWithCharts, compileSlideWithCharts, compileDeckWithCharts, applyTemplateWithCharts, relayoutNodeWithCharts, rethemeProjectWithCharts, NativeChartQuality } from './composer/chart.js';
...
function composerCompileSlide(request={}){return compileSlideWithCharts(compileSlide,request)}
function composerCompileDeck(spec,options={}){return compileDeckWithCharts(compileDeck,spec,options)}
function composerNormalizeSlideContent(input={}){return normalizeSlideContentWithCharts(input)}
function composerNormalizeDeckSpec(input={},options={}){return normalizeDeckSpecWithCharts(input,options)}
function composerValidateDeckSpec(input){return validateDeckSpecWithCharts(input)}
